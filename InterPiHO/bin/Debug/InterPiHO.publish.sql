...
GO
PRINT N'Création de [dbo].[Telephone]...';


GO
CREATE TABLE [dbo].[Telephone] (
    [NumeroTelephone] NVARCHAR (50) NOT NULL,
    [IdTroupe]        INT           NOT NULL,
    [Nom]             NVARCHAR (50) NOT NULL,
    PRIMARY KEY CLUSTERED ([NumeroTelephone] ASC)
);
...
GO
PRINT N'Création de [dbo].[FK_Mail_Troupes]...';


GO
ALTER TABLE [dbo].[Mail]
    ADD CONSTRAINT [FK_Mail_Troupes] FOREIGN KEY ([IdTroupe]) REFERENCES [dbo].[Troupes] ([Id]);
...
GO
PRINT N'Création de [dbo].[FK_Participants_Role]...';


GO
ALTER TABLE [dbo].[Participants]
    ADD CONSTRAINT [FK_Participants_Role] FOREIGN KEY ([Role]) REFERENCES [dbo].[Role] ([Nom]);


GO
PRINT N'Création de [dbo].[FK_Telephone_Troupes]...';


GO
ALTER TABLE [dbo].[Telephone]
    ADD CONSTRAINT [FK_Telephone_Troupes] FOREIGN KEY ([IdTroupe]) REFERENCES [dbo].[Troupes] ([Id]);
